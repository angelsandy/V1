#ifndef _MeshCilinder_
#define _MeshCilinder_
...
public:
	...
	MCilinder(ID3D11Device* d3d11Device, ID3D11DeviceContext* d3d11DevCon, int Slices, float Radius, float Height, LPCWSTR texturePath)
	{
